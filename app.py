...
# Cargar datos desde GitHub (CSV en formato raw)
@st.cache_data
def load_data():
    url = "https://raw.githubusercontent.com/RMhub398/cotizador-proveedores/main/Matriz_proveedores_Proservices.csv"
...
precio_lista = st.number_input("Ingresa el precio de lista", min_value=0.0, step=1000.0)
descuento_base = producto['% Desc. Proveedor']
precio_con_desc = precio_lista * (1 - descuento_base)

if precio_con_desc > 1500000:
    st.success("🎯 Aplica a descuento adicional")
