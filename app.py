...
# Cargar el archivo desde GitHub (puedes usar uno local si lo subes con el repositorio)
@st.cache_data
def load_data():
    url = "https://raw.githubusercontent.com/RMhub398/cotizador-proveedores/main/Matriz_proveedores_APP.csv"
...
modelo = st.sidebar.selectbox("Selecciona el modelo", df[df["Marca"] == marca]["Línea de Producto"].unique())
